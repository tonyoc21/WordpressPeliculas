...
function crear_base() {
  ...
  global $wpdb;
    ...
    $table_name = $wpdb->prefix . 'personage';
...
function enviar_formulario_por_email(){
	...
	$actor    = sanitize_text_field( $_POST['selectActors'] );
    $peliculas    = $_POST['selectMovies'] ;
	/*
	...
	*/
	...
	wp_redirect( get_home_url() . '/personajes'); exit;
